...
export class CommonHttpService {
    ...
    Insert_Company(endpont: string, hero: any): Observable<any> {
        return this.http
    ...
    GetAllResponseText(endpont: string): Observable<any> {
        return this.http.get(this.baseUrl + endpont, { responseType: 'text' }).pipe(
            tap((_) => {
                console.log(_);
                console.log(`Get all`);
            }),
    ...
    GetByResponseType(endpont: string, responsetype: any): Observable<any> {
        return this.http.get(this.baseUrl + endpont, { responseType: responsetype }).pipe(
            tap((_) => {
                console.log(_);
                console.log(`Get all`);
            }),
    ...
    uploadFile(endpont: string, file: any): Observable<any> {
    ...
    uploadFile_(endpont: string, file: any, header: any): Observable<any> {
        ...
        // Make http post request over api
        // with formData as req
        return this.http.post(this.baseUrl + endpont, file, header)
    }
}
